...
import com.example.user.yaadafy.DateTimeSorter;
import com.example.user.yaadafy.R;
import com.example.user.yaadafy.Reminder;
import com.example.user.yaadafy.ReminderAddActivity;
import com.example.user.yaadafy.ReminderDatabase;
import com.example.user.yaadafy.ReminderEditActivity;
...
public class ReminderList extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_reminder_lists,container, false);

        rb = new ReminderDatabase(getActivity().getApplicationContext());

// Initialize views
        mToolbar = (Toolbar) rootView.findViewById(R.id.toolbar);
        mAddReminderButton = (FloatingActionButton) rootView.findViewById(R.id.add_reminder);
        mList = (RecyclerView) rootView.findViewById(R.id.reminder_list);
        mNoReminderView = (TextView) rootView.findViewById(R.id.no_reminder_text);
