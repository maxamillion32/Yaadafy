 ...
 */
class AutocompleteFriendAdapter extends FirebaseListAdapter<Users> {
    private String mEncodedEmail;

    /**
     * Public constructor that initializes private instance variables when adapter is created
     */
    public AutocompleteFriendAdapter(Activity activity, Class<Users> modelClass, int modelLayout,
     ...
     */
    @Override
    protected void populateView(View view, final Users user) {
    ...
    private boolean isNotCurrentUser(Users user) {
    ...
    private boolean isNotAlreadyAdded(DataSnapshot dataSnapshot, Users user) {
