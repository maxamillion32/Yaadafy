...
public class Utils {
     ...
     */
    public static boolean checkIfOwner(Reminder shoppingList, String currentUserEmail) {
    ...
    public static HashMap<String, Object> updateMapForAllWithValue
            (final HashMap<String, Users> sharedWith, final String listId,
        ...
        if (sharedWith != null) {
            for (Users user : sharedWith.values()) {
     ...
     *
               The list of users the shopping list that has been updated is shared with.
    ...
    public static void updateTimestampReversed(FirebaseError firebaseError, final String logTagFromActivity,
                                               final String listId, final HashMap<String, Users> sharedWith,
                                               final String owner) {
        if (firebaseError != null) {
            ...
            firebaseRef.child(Constants.FIREBASE_LOCATION_USER_LISTS).child(owner)
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    Reminder list = dataSnapshot.getValue(Reminder.class);
                    if (list != null) {
