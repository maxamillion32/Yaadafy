 ...
 */
public class FriendAdapter extends FirebaseListAdapter<Users> {
    ...
    private HashMap<String, Users> mSharedUsersList;
     ...
     */
    public FriendAdapter(Activity activity, Class<Users> modelClass, int modelLayout,
     ...
     */
    @Override
    protected void populateView(View view, final Users friend) {
        ...
        ValueEventListener listener = sharedFriendInShoppingListRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                final Users sharedFriendInShoppingList = snapshot.getValue(Users.class);
                            ...
                            mFirebaseRef.updateChildren(updatedUserData, new Firebase.CompletionListener() {
                                ...
                                public void onComplete(FirebaseError firebaseError, Firebase firebase) {
                                    Utils.updateTimestampReversed(firebaseError, LOG_TAG, mListId,
                                            mSharedUsersList, MainActivity.mEncodedEmail);
                                }
                            });
                        }
                    });
     ...
     */
    public void setShoppingList(Reminder reminder) {
        this.mShoppingList = reminder;
     ...
     */
    public void setSharedWithUsers(HashMap<String, Users> sharedUsersList) {
     ...
     * @return
     */
    private HashMap<String, Object> updateFriendInSharedWith(Boolean addFriend, Users friendToAddOrRemove) {
        ...
        HashMap<String, Users> newSharedWith = new HashMap<String, Users>(mSharedUsersList);
        ...
        if (addFriend) {
            ...
            updatedUserData.put("/" + Constants.FIREBASE_LOCATION_REMINDER_LISTS + "/" + friendToAddOrRemove.getEmail()
